...
namespace QuantitySystem.Quantities.BaseQuantities
{
    ...
    public abstract partial class AnyQuantity<T> : BaseQuantity
    {
        ...
        {
            var DQ = new DerivedQuantity<T>(1, quantities);
            return DQ;
        }
       #endregion
        ...
        public static Q MultiplyScalarByGeneric<Q>(double factor, Q value)
        {
            ...
            var cq = Expression.Lambda<Func<Q>>(expr);
        ...
        {
            var q = (AnyQuantity<T>)base.Invert();
        ...
        public static AnyQuantity<T> Parse(string quantityName)
        {
            ...
            var qty = QuantityDimension.QuantityFrom<T>(QuantityDimension.DimensionFrom(QuantityType));
            return qty;
        ...
        public AnyQuantity<T> Clone()
        {
            ...
            if (t2.Unit != null) t2.Unit = Unit.Clone();
            return t2;
        }
